...
//		Accept username, password and confirm password and check following 
		//requirements:
//
//			Username and Password cannot be  empty, if so→ message=”Username and 
		//Password cannot
//			be empty”.
//			Password should be minimum 8 characters, if less → message=”Password is
		//too short”.
//			Password cannot contain username if so, → message=”Password cannot
		//contain username”.
//			Password should match confirmed password, if not  → message “Passwords  
		//do not match”.
